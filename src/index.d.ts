/**
 * A primitive state container that can be read from and written to.
 ...
 */
export declare function notify<State>(atom: Atom<State>): void;
...
export declare function observe<Key, Item>(
...
export interface ClientSyncer<Atoms extends AtomMap> {
	/**
